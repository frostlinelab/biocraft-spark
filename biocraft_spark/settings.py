"""
Django settings for biocraft_spark project.
...
SECRET_KEY = 'django-insecure-y=z&)yn9_4d&(e)@u@p5pu-0)f=$m915e_-fdxzmvh3k=e0u_6'
...
MIDDLEWARE = [
    'workbench.middleware.CorsMiddleware',
...
ROOT_URLCONF = 'biocraft_spark.urls'
...
WSGI_APPLICATION = 'biocraft_spark.wsgi.application'
