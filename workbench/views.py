...
SPA_INDEX = Path(__file__).resolve().parent.parent / "frontend" / "dist" / "index.html"


def home(request):
    if SPA_INDEX.exists():
        return HttpResponse(content=SPA_INDEX.read_bytes(), content_type="text/html; charset=utf-8")
